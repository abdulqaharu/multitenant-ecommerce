...
const Navbar = () => {
  ...
  return (
    <nav className="h-20 flex border-t border-b items-center justify-between font-medium bg-white">
      ...
      <div className="hidden lg:flex h-full">
        ...
        <Button className="border-l border-b-0 border-r-0 px-12 h-full rounded-none bg-black hover:bg-pink-400 hover:text-black transition-colors text-lg">
